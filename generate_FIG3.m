% GENERATEFIG3 fetches the data from the .MAT file and plots Figure 3. 
%
%   AUTHOR ================================================================
%
...
%% VISUALIZE AND COMPARE ERRORS W and W/O IMPEDANCE. forward Euler.
...
% Solvers to delete.
sSolverList_delete = ["rk", "rk0", "be", "be0"]; 
...
% Freq. to delete.
sFreqList_delete = ["Freq_50","Freq_100","Freq_300", "Freq_400", "Freq_500"]; 
...
% purposes. 
tbl_1.sSolver = categorical(tbl_1.sSolver, {'fe0', 'fe'}); 
...
for sDOFName = sDOFList
    ...
    subplot(3,length(sDOFList), iCounter); 
...
%% VISUALIZE AND COMPARE ERRORS W and W/O IMPEDANCE. Runge-Kutta.
...
% Solvers to delete.
sSolverList_delete = ["fe", "fe0", "be", "be0"]; 
...
%% VISUALIZE AND COMPARE ERRORS W and W/O IMPEDANCE. Backward Euler.
...
% Solvers to delete.
sSolverList_delete = ["rk", "rk0", "fe", "fe0"]; 
...
% Make solver variables cathegorical and reorder them for visualization
% purposes. 
tbl_1.sSolver = categorical(tbl_1.sSolver, {'be0', 'be'}); 
